...
namespace titanium {
	namespace bindings {
		...
		class AudiofocusBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* AudiofocusBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.appwerft.audiomanager.AudiomanagerModule", ::de::appwerft::audiomanager::AudiomanagerModule::bindProxy, ::de::appwerft::audiomanager::AudiomanagerModule::dispose}
			};
